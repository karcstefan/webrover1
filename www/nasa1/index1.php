...
//The Latitude of Prilep is 41.351730000000000000. The Longitude of Prilep is 21.562140000000000000.
        ...
        if ($lon!=0 && $lat!=0) {
            $lon = $lastPosition->lon;
            $lat = $lastPosition->lat;
            $weather = new Weather(42.000474, 21.398672);
        } 
        ?>
        <div id="latitude" style="display: none;"><?php //echo $lat; ?>42.000474</div>
        <div id="longitude" style="display: none;"><?php //echo $lon; ?>21.398672</div>
            ...
            <div id="inner-wrapper">
                ...
                <div class="half-wrapper">
                    <div class="block"><div class="header-h2"><span class="header-icons" id="camera"></span><h2>CAMERA</h2></div>
                        <!--<iframe src="http://192.168.1.101:8082" width="450" height="200" frameborder=1
						style="margin:2px;"></iframe>--> 
						<video src="WP_20140413_002.mp4" width="450" height="200"  autoplay="true" controls/>	
<!--style="-ms-transform: rotate(90deg);-webkit-transform: rotate(90deg);transform: rotate(90deg); margin-top: -94px;"-->
        ...
        <script>
            ...
            $(window).keyup(function(data) {
               req.open('GET', 'http://localhost/socket.php?msg=zapri', false);
               req.send();
            });
